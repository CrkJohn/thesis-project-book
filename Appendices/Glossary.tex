...
\glossarydef{lstm}{LSTM}{Long Short Term Memory}{Memoria Largo y Corto Plazo, son un tipo de redes neuronales recurrentes que son capaces de aprender dependencias de largo plazo}
...
\simpleglossarydef{bias}{High Bias}{El modelo poco condicionado a la entrada por lo que para un modelo predictivo dará resultados demasiado generales para cualquier conjunto de datos}