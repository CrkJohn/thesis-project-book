\newcommand{\glossarydef}[4]{
    \newglossaryentry{#1}{
        text={\textsc{#2}},
        long={\mbox{#3}},
        name={\textsl{\glsentrylong{#1}}\, \textsc{(}\glsentrytext{#1}\/\textsc{)}},
        first={\glsentryname{#1}},
        firstplural={\textsl{\glsentrylong{#1}\glspluralsuffix}\, (\textsc{\glsentrytext{#1}\glspluralsuffix})},
        description={{\rm #4}}
    }
}
...
\glossarydef{rnn}{RNN}{Recurrent Neural Network}{{\bf Pendiente}}
