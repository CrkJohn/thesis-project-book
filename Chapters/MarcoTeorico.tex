...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{Figures/som-implementation-example50.png}
\decoRule
\caption[Ejemplo de salida de \glsentrytext{som} uni-dimensional]{Ejemplo de salida de \glsentrytext{som} uni-dimensional con 50 neuronas. Implementación propia.}
...
\centering
\begin{tabular}{ccc}
\includegraphics[width=0.32\textwidth]{Figures/som-implementation-example10.png} & %
\includegraphics[width=0.32\textwidth]{Figures/som-implementation-example25.png} & %
\includegraphics[width=0.32\textwidth]{Figures/som-implementation-example100.png} \\
  (a) & (b) & (c) \\ [1em]
\end{tabular}
\decoRule
\caption[Comparación de salidas de \glsentrytext{som} uni-dimensional]{Comparación de salidas de \glsentrytext{som} uni-dimensional con (a) 10 neuronas (b) 25 neuronas y (c) 100 neuronas. Implementación propia.}
