...
En la \figureref{fig:som-example} se puede ver una aplicacion de los \gls{som}, en donde se realiza una clusterizacion de casos de homicidios donde los parametros son caracteristicas de los homicidios, segun \cite{mena2003investigative} este resultado da una buena aproximacion para sospechar de que estos son cometidos por personas distintas o si bien estan siendo perpetrados por un mismo individuo o grupo.
