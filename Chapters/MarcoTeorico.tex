...
\begin{figure}[H]
   ...
   \decoRule
   \caption[Comparaciones de \textsl{\glsentrylong{knn}}]{Comparaciones de \textsl{\glsentrylong{knn}}. (a)~Conjunto de entrenamiento $\train$, (b)~Dibujo de $p(y=1 \mid \rvx, \train)$, (c)~Dibujo de $p(y=2 \mid \rvx, \train)$, (d)~Dibujo de $\hat{y}(\rvx) = \argmax_{c} p(y=c \mid \rvx, \train)$. Tomado de \cite{murphymachinel}.}
