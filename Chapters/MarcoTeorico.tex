...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{Figures/som-implementation-example50.pdf}
\decoRule
...
\includegraphics[width=0.32\textwidth]{Figures/som-implementation-example25.pdf} & %
