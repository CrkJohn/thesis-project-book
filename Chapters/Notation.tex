...
\begin{tabular}{>{\centering}m{0.17\textwidth} p{0.7\textwidth}}
$\displaystyle a$ & Un escalar (entero o real)\\
$\displaystyle \va$ & Un vector\\
$\displaystyle \mA$ & Una matriz\\
$\displaystyle \tA$ & Un tensor\\
$\displaystyle \tka$ & Un token ($n$-grama, palabra, letra o byte)\\
$\displaystyle \vtka$ & Una secuencia de tokens, $\vtka = \tka_1 \, \ldots \, \tka_N$\\
...
$\displaystyle [a : b]$ & El intervalo discreto que incluye $a$ y $b$\\
...
$\displaystyle \norm{\vx}_p $          & Norma $\normlp$ de $\vx$, $\norm{\vx}_p = \sqrt[p]{\sum_i x_i^p}$ \\
$\displaystyle \norm{\vx}_\infty $      & Norma $\normmax$ de $\vx$, $\norm{\vx}_\infty = \max_i |x_i|$ \\
$\displaystyle \norm{\vx} = \norm{\vx}_2 $  & Norma $\normltwo$ de $\vx$ \\
