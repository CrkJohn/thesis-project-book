...
Equivalentemente, la regresión logística con modelos lineales se calculan como $\sigmoid(\vtheta^{\top} \vx)$ y permite realizar un suavizado de la regresión de forma que mitiga parte de los problemas de \gls{overfitting} y \gls{underfitting}, como se muestra en la \figureref{fig:logits-example}.
...
\subsubsection{Redes neuronales \glsentrylong{rnn} bidireccionales}
