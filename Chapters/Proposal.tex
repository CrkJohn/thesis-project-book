...
Equivalentemente, la regresión logística con modelos lineales se calculan como $\sigma(\vtheta^{\top} \vx)$ y permite realizar un suavizado de la regresión de forma mitiga parte de los problemas de \emph{overfitting} y \emph{bias}, como se muestra en la \figureref{fig:logits-example}.

\begin{figure}[H]
  \centering
  \missingfigure{Poner grafica de sigmoide}
  % \includegraphics[width=\textwidth]{Figures/general-architecture.pdf}
\decoRule
