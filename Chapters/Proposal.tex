...
\subsection{Predicción de etiquetas de Twitter con modelos lineales} \label{sec:twitter-prediction}
...
\subsection{Reconocimiento de \glsentrylong{namedent} con redes \glsentrylong{lstm}}
\todo{Pendiente} Bla
