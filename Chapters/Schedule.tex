...
\begin{tikzpicture}
  ...
  \Task{6}{Profundizacion literatura de \gls{nlp}}{8}{5}
...
\begin{tikzpicture}
  \GanttHeader{\textwidth}{2ex}{5cm}{16}
  \Task{9}{Prueba prueba prueba prueba}{0}{5}
  \Task{10}{Prueba prueba prueba prueba}{1}{2}
  \Task{11}{Prueba prueba prueba prueba}{2}{6}
  \Task{12}{Prueba prueba prueba prueba}{6}{6}
  \Task{13}{Prueba prueba prueba prueba}{10}{5}
  \Task{14}{Prueba prueba prueba prueba}{8}{5}
  \Task{15}{Prueba prueba prueba prueba}{14}{2}
  \Task{16}{Prueba prueba prueba prueba}{14}{1}
\end{tikzpicture}
