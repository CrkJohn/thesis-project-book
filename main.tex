...
\university{\href{http://www.university.com}{Escuela Colombiana de Ingeniería Julio Garavito}} % Your university's name and URL, this is used in the title page and abstract, print it elsewhere with \univname
\department{\href{http://department.university.com}{Programa de Ingeniería de Sistemas}} % Your department's name and URL, this is used in the title page and abstract, print it elsewhere with \deptname
...
\textsc{Bogot\'a, Colombia}\\[2cm]
 
\vfill

\includegraphics[scale=0.4]{University/escuela-logo.eps}\\ % University/department logo - uncomment to place it
