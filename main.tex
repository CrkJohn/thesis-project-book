...
\supervisor{Daniel Orlando \textsc{D\'{\i}az L\'opez}, \emph{Ph.D.}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\addchaptertocentry{\abstractname} % Add the abstract to the table of contents
  Se identifican diferentes metodologías de \glsentrylong{datascience} usadas comúnmente para el análisis de datos estructurados y no--estructurados. Luego se realiza una exploración del estado del arte en técnicas actuales de perfilamiento de cibercriminales y técnicas de clasificación de datos. Finalmente se realizan tres propuestas de modelos de \glsentrylong{nlp} que buscan soportar a Agencias de Seguridad del Estado en su lucha contra el crimen.
\end{abstract}

\begin{extraAbstract}
 Different commonly used \glsentrylong{datascience} methodologies are identified for structured and non-structured data analysis. After that a State of the Art exploration of current techniques for cybercriminal profiling and data classification is made. Lastly, three \glsentrylong{nlp} model proposals are made that seek to support State Security Agencies in their fight against crime.
\end{extraAbstract}
...
\include{Appendices/ProjectInformation}
\include{Appendices/KeyConcepts}
